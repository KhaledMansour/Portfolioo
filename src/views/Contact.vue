  ...
  <div>
    ...
    <ul>
      <li>
        ...
        <a href="mailto:khaledelmans22@gmail.com" target="_blank">khaledelmans22@gmail.com</a>
      </li>
      <li>
        <i class="fa fa-linkedin fa-lg fa-fw" style="vertical-align: -5%;"></i>
        <a href="https://www.linkedin.com/in/khaled-mans/" target="_blank">LinkedIn Profile</a>
      </li>
      <li>
        <i class="fa fa-github fa-lg fa-fw"></i>
        <a href="https://github.com/KhaledMansour" target="_blank">GitHub Profile</a>
      </li>
    </ul>
